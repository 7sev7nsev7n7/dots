...
hi('StatusLine',   { bg = 'Gray',fg = 'Black', bold = true,       ctermbg = 'Gray', ctermfg = 'Black', cterm = { bold = true }})
...
hi('CursorLineNr', { fg = 'Cyan', bold = true,                ctermfg = 'Cyan', cterm = { underline = true, bold = true } })
...
hi('Title',        { fg = 'Red', bold = true,               ctermfg = 'Cyan' })
...
hi('Identifier',   { fg = 'Blue',                            ctermfg = 'Cyan', cterm = { bold = true } })
hi('Statement',    { fg = 'Yellow', bold = true,               ctermfg = 'Yellow' })
hi('PreProc',      { fg = 'White',                            ctermfg = 'White' })
hi('Type',         { fg = 'DarkRed', bold = true,               ctermfg = 'DarkRed' })

...
hi('StatusLineNC',          {link=StatusLine,cterm={reverse=true}})
...
hi('CursorLine',    {})
hi('CursorLineNr',  {ctermfg=6,ctermbg=0,cterm={reverse=true}})

...
hi('StatusLine',            {ctermbg=6,ctermfg=0,cterm={bold=true}})
hi('StatusLineNC',          {ctermbg=0,ctermfg=4})
...
hi('CurSearch',       {cterm={reverse=true}})
...
hi('CursorLineNr',  {ctermfg=8,ctermbg=0,cterm={reverse=true}})
hi('DiffAdd',       {ctermbg=22,ctermfg=0})
hi('DiffChange',    {ctermfg=8,ctermbg=19,cterm={bold=true}})
hi('DiffDelete',    {ctermfg=52,ctermbg=52})
hi('Directory',     {ctermfg=13})
hi('FoldColumn',    {ctermbg=8})
hi('Folded',        {ctermbg=8})
hi('LineNr',        {ctermfg=8})
hi('MatchParen',    {ctermbg=240,ctermfg=15})
hi('MoreMsg',       {ctermfg=12})
hi('Pmenu',         {ctermbg=13})
hi('PmenuSel',      {ctermbg=0})
hi('PmenuThumb',    {ctermfg=0})
hi('Question',      {ctermfg=14})
hi('Search',        {ctermbg=242,ctermfg=0})
...
hi('Title',         {ctermfg=15,cterm={bold=true}})
hi('Visual',        {ctermbg=238})
hi('WarningMsg',    {ctermfg=12})
hi('Comment',       {ctermfg=8})
hi('Constant',      {ctermfg=1})
hi('Special',       {ctermfg=9})
hi('Identifier',    {ctermfg=2,cterm={bold=true}})
hi('Statement',     {ctermfg=12})
hi('PreProc',       {ctermfg=14})
hi('Type',          {ctermfg=10})
hi('Underlined',    {ctermfg=244,cterm={underline=true}})
hi('Ignore',        {ctermfg=0})

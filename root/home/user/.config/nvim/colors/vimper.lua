...
hi('StatusLineNC',          {ctermbg=0,ctermfg=6,cterm={bold=true,underline=true}})
...
hi('CurSearch',       {ctermfg=0,ctermbg=2,cterm={bold=true}})
...
hi('CursorColumn',  {ctermfg=0,ctermbg=6})
hi('CursorLine',    {})
hi('CursorLineNr',  {ctermfg=0,ctermbg=6})
...
hi('Title',         {ctermfg=0,ctermbg=6,cterm={bold=true}})
